...
urlpatterns = patterns('chado.views',
    ...
    url(r'^context_viewer/search_repeat/$', 'context_viewer_search_repeat', {'template_name' : 'chado/context/index.html'}, name='context_viewer_search_repeat'),
    url(r'^context_viewer/search_repeat/(?P<focus_name>[^\/]+)/$', 'context_viewer_search_repeat', {'template_name' : 'chado/context/search_repeat.html'}, name='context_viewer_search_repeat'),
