...
#
# 1.) a related_name field was created for Foreign Keys to avoid conflicts using %(class)s and the variable name. 
#      This creates related names using the class name and var name.
#
# 2.) Correcting capitalization issues that resulted in improper foreign key relations for certain tables.
#
# 3.) Set the character length of gffattr and gff3attr to 100 (changed from -1).
#
