...
function context_viewer( container_id, color, data, optional_parameters ) {
  	  ...
  	  .attr("class", function (d) {
            ...
            optional_parameters.focus == d.family) {
  	  	  ...
  	  	  return "point no_fam";
                   ...
                   optional_parameters.selective_coloring) {
  	  	  return "point single";
  	  	} return "point";
      })
    ...
    var partition = false;
  	gene_groups.each(function (d) {
        ...
        if (optional_parameters.inter_track !== undefined &&
            ...
            partition = true;
            drawLine(closest, end_genes[d.name]);
          }
          if (!partition && begin_genes[d.name] === undefined &&
            ...
            partition = false;
            drawLine(d, begin_genes[closest.name]);
  	      }
          if (partition) {
  ...
  d3.selectAll(".axis_right text")
    ...
    .on("click", function (d, y) {
      ...
      // will called if optional_parameters.right_axis_clicked !== undefined
