...
3. Once the fasta is converted to a gff then you can load it using the GMOD bulk loader:
    ...
    ```
4. If you loaded polypeptides from a fasta file then refer to the Cleaning up section on how to make sure they are appropriately named.
...
2. If you don't want to run the previous command on a bulk of fasta files then use the bash script:
